...
function Transaction(serialized) {
  ...
  this.nVersionGroupId = NVERSIONGROUPID_SET;
  this.nExpiryHeight = DEFAULT_EXPIRY_HEIGHT;
  this.valueBalance = USE_VALUE_BALANCE;
...
// valueBalance is specificly set to 0. We expect no sapling interaction.
var CURRENT_VERSION = 4;
var FOVERWINTERED_STATUS = true;
var NVERSIONGROUPID_SET = 0x892F2085;
var DEFAULT_NLOCKTIME = 0;
var MAX_BLOCK_SIZE = 1000000;
var DEFAULT_EXPIRY_HEIGHT = 0;
var USE_VALUE_BALANCE = new BN(0);
...
Transaction.prototype._newTransaction = function () {
  ...
  this.fOverwintered = FOVERWINTERED_STATUS;
  this.nVersionGroupId = NVERSIONGROUPID_SET;
  this.nExpiryHeight = DEFAULT_EXPIRY_HEIGHT;
  this.valueBalance = USE_VALUE_BALANCE;
};
